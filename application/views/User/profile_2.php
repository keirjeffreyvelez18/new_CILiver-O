        ...
        <div class="row container profile" >
              <div class="col-lg-5">
                <table class="pull-right" >
                    ...
                    <tr class="row">
                      <td>
                        <span style="color:#ffffff;">Name  : </span>&nbsp&nbsp
                      </td>
                    ...
                    <tr class="row">
                      <td>
                        <span style="color:#ffffff;">Password  : </span> &nbsp&nbsp
                      </td>
                    ...
                    <tr class="row">
                      <td> 
                         <span style="color:#ffffff;">Birthday  : </span> 
                      </td>
