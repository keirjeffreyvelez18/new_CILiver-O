					...
					<div id="WaterTrackerMenu" class="col-lg-12  tab-pane fade in active">
						...
						<div>
							...
							<div class="pull-right">
								<img class="center-block animated swing pull-right" style=" max-height: 12%; max-width: 12%; margin-right: 10%;" src="<?php echo base_url('Lib/imgs/Liver_D.png')?>" alt="liver Doctor"/>
